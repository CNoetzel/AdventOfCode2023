...
def main():
    ...
    print(f'Task 1: Sum of calibration values is {sum_calibration_values(lines, get_calibration_value)}')
    print(f'Task 2: Sum of calibration values is {sum_calibration_values(lines, get_calibration_value_advanced)}')
